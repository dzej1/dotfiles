...
if [ ! -f "$SSH_KEY_FILE" ]; then
  echo -e "# Paste your '$SSH_KEY_NAME' PRIVATE key below and save" >"$SSH_KEY_FILE"
  echo -e "# Also, delete these 3 comments on the top or the key will be invalid" >>"$SSH_KEY_FILE"
  echo -e "# Once done modifying this file, save with :wq" >>"$SSH_KEY_FILE"
  vim "$SSH_KEY_FILE"
...
SSHCONFIG
#FIXME: add other config items
# Host staging.tradeapp
#   Hostname 51.158.61.18
#
# Host czprod.tradeapp
#   Hostname 151.115.61.240
#   ProxyJump root@51.158.61.18
#
# Host huprod.tradeapp
#   Hostname 151.115.75.168
#   ProxyJump root@51.158.61.18
#
# Host plprod.tradeapp
#   Hostname 151.115.60.78
#   ProxyJump root@51.158.61.18
#
# Host prod1
#   Hostname 172.16.9.74
#   ProxyJump root@spider.storytlrs.cz
#
# Host dev2
#   Hostname 172.16.9.101
#   ProxyJump root@spider.storytlrs.cz
...
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
# FIXME: go through packages i dont know and remove not needed / add needed
# -----------------------------------------------------------------------------
# -----------------------------------------------------------------------------
...
ln -snf ../../../../zshrc/zshrc-file.sh ~/.zshrc >/dev/null 2>&1
